...
**Note:** Readme Auto-generated  (2020-04-24 13:27 UTC). Do not edit this file.
...
[Read more](./docs/AA-Appendix/business-plan.md)
<!-- /buisness-plan -->
...
[Read more](./docs/02-Setting/00-Setting-Introduction.md)
<!-- /setting-overview -->
...
* **[Albert Strand](./docs/30-Season-Three/10-Characters/albert-strand.md)** (seasons 3–5; guest season 1; recurring season 2)
...
* **[Ben Franklin](./docs/10-Season-One/10-Characters/ben-franklin.md)** (seasons 3–5; guest season 1; recurring season 2)

* **[Bubba](./templates/character-sheet.md)** (seasons 3–5; guest season 1; recurring season 2)

* **[Clarance Dankworth](./docs/30-Season-Three/10-Characters/clarance-dankworth.md)** ()
...
* **[David Strand](./docs/10-Season-One/10-Characters/david-strand.md)** (season 1)
David Strand was a Son of Liberty, frustrated by the settled peace between America and England.
* **[Ephram Biggs](./docs/10-Season-One/10-Characters/ephram-biggs.md)** (seasons 3–5; guest season 1; recurring season 2)
Ephram Biggs discovers the Toltec Mound, triggering the
* **[Henry Strand](./docs/10-Season-One/10-Characters/henry-strand.md)** (seasons 3–5; guest season 1; recurring season 2)

* **[John Hale](./docs/10-Season-One/10-Characters/john-hale.md)** (seasons 3–5; guest season 1; recurring season 2)
...
* **[Crown Victoria Orbital](./docs/30-Season-Three/20-Locations/crown-victoria-orbital.md).** Crown Victoria Orbital is the Toltec orbital over Earth.
* **[Elysion Orbital](./docs/30-Season-Three/20-Locations/elysion-orbital.md).** Elysion Orbital is the Precursor Habitat over Earth.
* **[Elysion System](./docs/02-Setting/02-Geography/Elysion/elysion-system.md).** Elysion is a binary system (G2V, KV5). Third planet around Elysion Junior is Elysion, the focal planet for the system.
...
| # | Synopsis |
| :-: | - |
| **[1](./docs/10-Season-One/00-Overview.md)** | A band of radicals seek to separate from England. But, advanced tech is discovered in the Ohio, leading to a three-way struggle for who would control it. |
| **[2](./docs/20-Season-Two/01-Overview.md)** | The second season focuses on Albert trying to earn the trust of the rebels after supporting the monarch, but ultimately deciding to find a way to escape again. Meanwhile... |
| **[3](./docs/30-Season-Three/01-Overview.md)** | The second season focuses on Albert trying to earn the trust of the rebels after supporting the monarch, but ultimately deciding to find a way to escape again. Meanwhile... |
