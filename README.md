...
**Note:** Readme Auto-generated  (2020-01-20 12:53 UTC). Do not edit this file.
...
* **[Absent Aliens](./docs/AA-Appendix/Tropes/Advanced-Acropolis.md).** A lost or hidden civilization much more advanced than the rest of the world outside it.
* **[Absent Aliens](./docs/AA-Appendix/Tropes/Absent-Aliens.md).** Humans are the only intelligent life in the universe.
* **[Absent Aliens](./docs/AA-Appendix/Tropes/LowCultureHighTech.md).** Not so when you have Low Culture High Tech; this is a faction, culture, or race that uses technology far in advance of their scientific and cultural knowledge, often for warfare.
